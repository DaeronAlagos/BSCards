...
>
    ...
    <xsl:template match="bs:roster/bs:forces/bs:force">
        <xsl:apply-templates
      select="bs:selections/bs:selection[@type='model']"
    />
    </xsl:template>
    ...
    <xsl:template match="bs:selection[@type='model']">
        <div
      class="w-60 h-[21rem] bg-white border-solid border border-black m-1 print:m-0 text-xs font-mono print:break-inside-avoid"
    >
          ...
          >
                        <div
              class="py-1 px-2 rounded-bl-lg bg-red-600 text-white"
            >
                            <xsl:value-of
              ...
              />
                    ...
                    <xsl:otherwise>
                        <div
              class="py-1 px-2 rounded-bl-lg bg-sky-800 text-white"
            >
                            <xsl:value-of
            ...
            <div class="flex">
                ...
                <div class="basis-3/5 flex flex-row items-end justify-between">
                    <div
            class="border border-solid border-black w-7 h-[1.1rem]"
          />
            ...
            <div class="my-2">
                <div
          class="align-middle px-3 py-0.5 font-semibold text-[0.6rem] bg-sky-800 text-white print:text-black print:bg-gray-200"
        >
                    WEAPONS
                    &amp; EQUIPMENT
                </div>
